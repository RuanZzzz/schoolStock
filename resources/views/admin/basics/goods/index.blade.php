                        ...
                        <div class="ibox-content" style="border-top: 0px;padding-top: 0px">
                            ...
                            <div class="fixed-table-pagination" style="display: block;">
                                <div class="pull-left pagination-detail">
                                    ...
                                    <span id="totalGoods" class="pagination-info"></span>
                                </div>
                                <div class="pull-right pagination">
                                    <ul id="goodsTablePager" class="pagination pagination-outline">
...
<script>
    ...
    function getGoodsTableData(page) {
        $.ajax({
            type : 'get',
            url : '/admin/goods/getCount',
            data : {
